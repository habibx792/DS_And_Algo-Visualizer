...
foot.innerHTML = `
  <div class="w-full bg-gradient-to-b from-navySoft via-navy to-black text-black-300 py-16 px-6 mt-20 border-t border-white/10 backdrop-blur-md bg-glassWhite/10">
